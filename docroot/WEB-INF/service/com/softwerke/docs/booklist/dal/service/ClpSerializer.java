...
import com.softwerke.docs.booklist.dal.model.AuthorClp;
import com.softwerke.docs.booklist.dal.model.BookClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"BookList-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "BookList-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.softwerke.docs.booklist.dal.model.impl.AuthorImpl")) {
		...
		if (oldModelClassName.equals(
					"com.softwerke.docs.booklist.dal.model.impl.BookImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.softwerke.docs.booklist.dal.NoSuchAuthorException();
		}

		if (className.equals(
					"com.softwerke.docs.booklist.dal.NoSuchBookException")) {
			return new com.softwerke.docs.booklist.dal.NoSuchBookException();
		}
