...
public class AuthorWrapper implements Author, ModelWrapper<Author> {
	...
	*/
	...
	@Override
	public int compareTo(com.softwerke.docs.booklist.dal.model.Author author) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.softwerke.docs.booklist.dal.model.Author> toCacheModel() {
		return _author.toCacheModel();
	}

	@Override
	public com.softwerke.docs.booklist.dal.model.Author toEscapedModel() {
		return new AuthorWrapper(_author.toEscapedModel());
	}

	@Override
	public com.softwerke.docs.booklist.dal.model.Author toUnescapedModel() {
