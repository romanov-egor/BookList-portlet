...
import com.softwerke.docs.booklist.NoSuchBookException;
import com.softwerke.docs.booklist.model.Book;
import com.softwerke.docs.booklist.model.impl.BookImpl;
import com.softwerke.docs.booklist.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
			BookModelImpl.FINDER_CACHE_ENABLED, BookImpl.class,
	...
	public Book findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchBookException, SystemException {
		Book book = fetchByGroupId_First(groupId, orderByComparator);
	...
	public Book findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchBookException, SystemException {
		Book book = fetchByGroupId_Last(groupId, orderByComparator);
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Book book : findByGroupId(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(book);
		}
	}
	...
	@Override
	public Book updateImpl(com.softwerke.docs.booklist.model.Book book)
		throws SystemException {
		book = toUnwrappedModel(book);
	 ...
	 */
	@Override
	public List<com.softwerke.docs.booklist.model.Author> getAuthors(long pk)
		throws SystemException {
	...
	public void addAuthors(long pk,
		List<com.softwerke.docs.booklist.model.Author> authors)
		throws SystemException {
		for (com.softwerke.docs.booklist.model.Author author : authors) {
			bookToAuthorTableMapper.addTableMapping(pk, author.getPrimaryKey());
		}
	}
	...
	public void setAuthors(long pk,
		...
		try {
			...
			for (int i = 0; i < authors.size(); i++) {
				com.softwerke.docs.booklist.model.Author author = authors.get(i);
			...
			FinderCacheUtil.clearCache(BookModelImpl.MAPPING_TABLE_BL_BOOK_AUTHOR_NAME);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.softwerke.docs.booklist.model.Book")));
		...
		bookToAuthorTableMapper = TableMapperFactory.getTableMapper("BL_Book_Author",
	...
	protected TableMapper<Book, com.softwerke.docs.booklist.model.Author> bookToAuthorTableMapper;
